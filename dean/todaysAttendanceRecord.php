...
<body>
   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Today's Attendance Record</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Today's Attendance Record (<?php echo date("d-m-yy")?>)</h2></strong>
                            </div>
                            <div class="card-body">
        ...
        where tblfaculty.Id = '$facultyId' and date(tblattendance.DateTaken) = CURDATE();");        
        $cnt=1;
