   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <?php
        $ret=mysqli_query($con,"SELECT tbladmin.staffId, tbladmin.firstName, tbladmin.lastName, tbladmin.otherName,tbladmin.emailAddress, tbladmin.phoneNo, tbladmin.dateCreated,tbladmintype.adminTypeName,tbladmin.isAssigned
        from tbladmin 
        ...
        while ($row=mysqli_fetch_array($ret)) {
                ...
                <td><?php  if( $row['isAssigned'] == 1){echo "Assigned";}else{echo "UnAssigned";}?></td>
