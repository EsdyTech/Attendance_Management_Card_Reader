...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $statusMsg="An Administrator has been Assigned to this Department!";
            ...
            $query=mysqli_query($con,"insert into tblassignedadmin(staffId,departmentId,facultyId,dateAssigned) value('$staffId','$departmentId','$facultyId','$dateAssigned')");
            if($query){
                ...
                if($querys == True){
                    ...
                    $statusMsg="Administrator Assigned Successfully!";
                }
                else
                {
                    $alertStyle ="alert alert-danger";
   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Assign Administrator</li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="animated fadeIn">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Assign Administrator</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <label for="select" class=" form-control-label">Select Administrator</label>
                                             <?php 
                                                $que=mysqli_query($con,"select * from tbladmin where adminTypeId != 1 and isAssigned = 0"); //selects unassigned staffs                        
                ...
                <br><br>
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">All Assigned Administrator</h2></strong>
                            </div>
                            <div class="card-body">
        ...
        while ($row=mysqli_fetch_array($ret)) {
                ...
                <td><a onclick="return confirm('Are you sure you want to delete?')" href="deleteAssignedAdmin.php?delid=<?php echo $row['staffId'];?>&fid=<?php echo $row['fingerPrintId'];?>" title="Delete"><i class="fa fa-trash fa-1x"></i></a></td>
                </tr>
                <?php 
                $cnt=$cnt+1;
                }?>
