   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Today's Course Attendance</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Today's Course Attendance Record</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
        ...
        if(isset($_POST['submit'])){
            ...
            where tblcourse.courseId ='$courseId' and date(tblattendance.DateTaken) = CURDATE();");    
