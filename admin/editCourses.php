...
$query = mysqli_query($con,"select * from tblcourse where courseId='$_SESSION[editCourseId]'");
...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($con,"select * from tblcourse where courseTitle ='$courseTitle' and departmentId ='$departmentId' and courseId != '$_SESSION[editCourseId]'");
    ...
    if($ret > 0){
      ...
      $statusMsg="This Course already exist in this department!";
        ...
        $query=mysqli_query($con,"update tblcourse set courseTitle='$courseTitle',courseCode='$courseCode',courseUnit='$courseUnit',facultyId='$facultyId', departmentId='$departmentId', staffId='$staffId'
        where courseId='$_SESSION[editCourseId]'");
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">Course ID</label>
                                                        <input id="" maxlength="3" onkeypress="return isNumber(event)" name="courseId" type="text" class="form-control cc-cvc" value="<?php echo $rowi['courseId']?>" Required data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" placeholder="Course ID">
                                                        </div>
                                                    </div>
