...
$facultyId=$_POST['facultyId'];
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($con,"insert into tblstudent(firstName,lastName,otherName,matricNo,levelId,facultyId,departmentId,cardId,dateCreated) value('$firstname','$lastname','$othername','$matricNo','$levelId','$facultyId','$departmentId','$cardId','$dateCreated')");
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="" name="cardId" type="text" class="form-control cc-cvc" value="" data-val="true" Required data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" placeholder="Card ID">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="row">
