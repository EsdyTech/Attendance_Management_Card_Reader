...
function showCourses(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","ajaxCallCourses.php?deptId="+str,true);
        xmlhttp.send();
    }
}
</script>
   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Course Attendance</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Course Attendance Record</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
        ...
        if(isset($_POST['submit'])){
            ...
            where tblcourse.courseId ='$courseId' and tblfaculty.Id = '$facultyId' and tbldepartment.Id = '$departmentId'");    
            ...
            INNER JOIN tbldepartment ON tbldepartment.Id = tblcourse.departmentId
            INNER JOIN tblfaculty ON tblfaculty.Id = tblcourse.facultyId
            where date(DateTaken) = '$singleDate' and tblcourse.courseId ='$courseId'");          
            ...
            INNER JOIN tbldepartment ON tbldepartment.Id = tblcourse.departmentId
            INNER JOIN tblfaculty ON tblfaculty.Id = tblcourse.facultyId
            where date(DateTaken) between '$fromDate' and '$toDate' and tblcourse.courseId ='$courseId'");          
