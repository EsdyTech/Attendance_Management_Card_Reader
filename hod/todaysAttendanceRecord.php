...
<body>
   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Today's Attendance Report</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Today's Attendance Report (<?php echo date("d-m-yy")?>)</h2></strong>
                            </div>
                            <div class="card-body">
        ...
        <?php
        $time_in_12_hour_format  = date("g:i a", strtotime("13:30")); // convert time to 12 hour format

        $ret=mysqli_query($con,"SELECT tblattendance.FingerPrintId, tblstaff.staffId, tblstaff.firstName,tblstaff.lastName, 
        tblstaff.otherName, tblstaff.phoneNo, tblstaff.emailAddress, tblattendance.CheckInTime,tblattendance.CheckOutTime, 
        tblattendance.DateTaken, tblattendance.FacultyId, tblfaculty.facultyName, tbldepartment.departmentName, tblroles.roleName   
        from tblattendance 
        ...
        where tbldepartment.Id = '$departmentId' and date(tblattendance.DateTaken) = CURDATE();");        
        $cnt=1;
