          ...
          <!-- <div class="col-xl-3 col-sm-6 col-md-3">
            <div class="single-footer-widget footer_2">
              <div class="single_contact_info">
               <h3>Lagos -Ikorodu</h3>
                <p>Lagos State Polytechnic, Ikorodu, Lagos State. Lagos State Polytechnic</p>
                <p>info@mylaspotech.edu.ng</p>
              </div>
            </div>
          </div> -->
        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Attendance Management System. All rights reserved
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                  </p>
                </div>
              </div>
