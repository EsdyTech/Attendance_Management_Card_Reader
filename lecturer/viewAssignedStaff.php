   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h3 align="center">All <?php echo $departmentName;?> Staff</h3></strong>
                            </div>
                            <div class="card-body">
        ...
        while ($row=mysqli_fetch_array($ret)) {
                ...
                <td><a href="editStaff.php?editid=<?php echo $row['staffId'];?>" title="View Full Details"><i class="fa fa-eye fa-1x"></i></a></td>
                </tr>
                <?php 
                $cnt=$cnt+1;
                }?>
