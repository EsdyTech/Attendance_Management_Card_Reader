                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <label for="x_card_code" class="control-label mb-1">ID</label>
                                                        <input id="" maxlength="3" onkeypress="return isNumber(event)" name="courseId" type="text" class="form-control cc-cvc" value="<?php echo $rowi['courseId']?>" Required data-val="true" data-val-required="Please enter the security code" data-val-cc-cvc="Please enter a valid security code" placeholder="ID">
                                                        </div>
                                                    </div>
