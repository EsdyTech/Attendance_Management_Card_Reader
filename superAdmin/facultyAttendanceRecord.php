   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Faculty Attendance</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Faculty Attendance Record</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
        ...
        if(isset($_POST['submit'])){
            ...
            if($typeId == 1){ //All Attendance per faculty
            ...
            INNER JOIN tbldepartment ON tbldepartment.Id = tblattendance.DepartmentId
            INNER JOIN tblfaculty ON tblfaculty.Id = tblattendance.FacultyId
            where date(DateTaken) = '$singleDate' and tblfaculty.Id = '$facultyId'");          
            ...
            INNER JOIN tbldepartment ON tbldepartment.Id = tblattendance.DepartmentId
            INNER JOIN tblfaculty ON tblfaculty.Id = tblattendance.FacultyId
            where date(DateTaken) between '$fromDate' and '$toDate' and tblfaculty.Id = '$facultyId'");          
