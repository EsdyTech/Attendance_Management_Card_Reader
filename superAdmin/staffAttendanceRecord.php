...
function showValues(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","ajaxCallStaffDetails.php?sid="+str,true);
        xmlhttp.send();
    }
}
</script>
   ...
   <!-- /#left-panel -->
    ...
    <div id="right-panel" class="right-panel">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><h2 align="center">Staff Attendance Record</h2></strong>
                            </div>
                            <div class="card-body">
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <label for="select" class=" form-control-label">Select Staff</label>
                                             <?php 
                                                $que=mysqli_query($con,"select * from tblstaff where isAssigned = 1"); //selects assigned staffs                        
                                                $count = mysqli_num_rows($que);
                                                if($count > 0){                       
                                                    echo ' <select required name=""  onchange="showValues(this.value)"class="custom-select form-control">';
        ...
        if(isset($_POST['submit'])){
            ...
            INNER JOIN tbldepartment ON tbldepartment.Id = tblattendance.DepartmentId
            INNER JOIN tblfaculty ON tblfaculty.Id = tblattendance.FacultyId
            where date(DateTaken) = '$singleDate' and staffId = '$staffId'");    
            ...
            INNER JOIN tbldepartment ON tbldepartment.Id = tblattendance.DepartmentId
            INNER JOIN tblfaculty ON tblfaculty.Id = tblattendance.FacultyId
            where date(DateTaken) between '$fromDate' and '$toDate' and staffId = '$staffId'");             
        ...
        ?>
                            ...
                            <td><a href="staffDetails.php?editid=<?php echo $row['staffId'];?>" title="View Full Details"><i class="fa fa-eye fa-1x"></i></a></td>
                            </tr>
                            <?php 
                            $cnt=$cnt+1;
                            }?>
